...
import Lab7.Shatilov.ArrayListTest.Chair;
import Lab7.Shatilov.ArrayListTest.FurnitureAbs;
import Lab7.Shatilov.ArrayListTest.Sofa;
import Lab7.Shatilov.ArrayListTest.Table;
import java.util.Scanner;

public class CustomArrayTest {
    private static CustomArray<FurnitureAbs> furniture = null;

    public CustomArrayTest(){
        furniture = new CustomArray<>();
        char menu;
        do {
